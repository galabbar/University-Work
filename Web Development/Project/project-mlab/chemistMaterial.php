...
<head>
  ...
  <title>Mlab &rarr; Chemist Raw Materials</title>
</head>
...
<body id="template" class="d-flex">
  ...
  <nav class="d-flex flex-column flex-shrink-0 bg-danger">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a href="chemist.php" class="nav-link py-3" data-bs-toggle="tooltip" data-bs-placement="right"
          title="Combinations">
          <img src="./imgs/combine.png" alt="combinations" width="32px" />
        </a>
      </li>
      <li class="nav-item">
        <a href="chemistMaterial.php" class="nav-link active py-3" data-bs-toggle="tooltip" data-bs-placement="right"
          title="Raw Material">
  ...
  <!-- local  -->
  <script src="./js/chemistMaterial.js"></script>
</body>
